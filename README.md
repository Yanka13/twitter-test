...
Ensuite, nous devons modifier le fichier app/**init**.py pour que le module flask-migrate puisse identifier les changements effectués dans les modèle de l’app Python afin de les retranscrire en tant que migration dans la db:
...
Let's teck a step back. What would happen if you execute this following code multiple times?
